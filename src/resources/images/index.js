const Images = {
  ...
  categoryvector: require('../../assets/Category_Page/category-vector.png'),
  image: require('../../assets/Home_Screen/health1.png'),
  Wallet: require('../../assets/My_Account/wallet.png'),
